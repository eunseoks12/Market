...
public interface TableInterface{
	...
	final String Buy = "INSERT INTO order_tbl(orderid, id, goodsid, goodscount, totalprice) VALUES(orderid.NEXTVAL,?,?,?,?)";
	final String UserOrderList = "SELECT * FROM order_tbl where id = ? order by orderid asc";
	...
	abstract int productBuy(String id, String goodsid, int goodscount, int totalprice);
